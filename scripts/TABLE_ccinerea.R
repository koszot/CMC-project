...
setwd("~/Desktop/MTA/AS_project/FILES_ccinerea/")

isoforms <- read_tsv("EXPRESSION_ccinerea/isoforms.fpkm_tracking", col_names = T, cols(.default = col_guess(), tracking_id = col_character(), gene_id = col_character()))   
isoforms <- isoforms %>%
...
annotation <- read_tsv("GENOME_ccinerea/ccinerea_AS_annotation.gtf",  col_names = c("chr", "maker","type", "start", "end", "att1", "strand", "att2", "attributes")) %>%
...
genes <- read_tsv("EXPRESSION_ccinerea/genes.fpkm_tracking", col_names = T, cols(.default = col_guess(), tracking_id = col_character(), gene_id = col_character()))     # betöltjük az isoform FPKM táblát
genes <- genes %>% select(gene_id, VM_FPKM, H_FPKM, P1_FPKM, P2_FPKM, YFB_K_FPKM, YFB_L_FPKM, YFB_T_FPKM, FB_KL_FPKM, FB_T_FPKM)            # kiválasztjuk a minket érdeklő oszlopokat
...
for (x in 1:length(genes$gene_id)) {
  if (is.na((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_T_FPKM[x], genes$FB_T_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_T_FPKM[x], genes$FB_T_FPKM[x])))) {
    genes$DEVREG_T[x] <- NA 
  } else if ((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_T_FPKM[x], genes$FB_T_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_T_FPKM[x], genes$FB_T_FPKM[x])) >= 4) {
    genes$DEVREG_T[x] <- T
  } else {
    genes$DEVREG_T[x] <- F
  }
...
for (x in 1:length(genes$gene_id)) {
  if (is.na((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_K_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_K_FPKM[x], genes$FB_KL_FPKM[x])))) {
    genes$DEVREG_K[x] <- NA 
  } else if ((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_K_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_K_FPKM[x], genes$FB_KL_FPKM[x])) >= 4) {
    genes$DEVREG_K[x] <- T
  } else {
    genes$DEVREG_K[x] <- F
  }
...
for (x in 1:length(genes$gene_id)) {
  if (is.na((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_L_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_L_FPKM[x], genes$FB_KL_FPKM[x])))) {
    genes$DEVREG_L[x] <- NA 
  } else if ((max(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_L_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$H_FPKM[x], genes$P1_FPKM[x], genes$P2_FPKM[x], genes$YFB_L_FPKM[x], genes$FB_KL_FPKM[x])) >= 4) {
    genes$DEVREG_L[x] <- T
  } else {
    genes$DEVREG_L[x] <- F
  }
...
for (x in 1:length(genes$gene_id)) {
  if (is.na((max(genes$YFB_K_FPKM[x], genes$YFB_L_FPKM[x], genes$YFB_T_FPKM[x])/min(genes$YFB_K_FPKM[x], genes$YFB_L_FPKM[x], genes$YFB_T_FPKM[x])))) {
    genes$DEVREG_YFB[x] <- NA 
  } else if ((max(genes$YFB_K_FPKM[x], genes$YFB_L_FPKM[x], genes$YFB_T_FPKM[x])/min(genes$YFB_K_FPKM[x], genes$YFB_L_FPKM[x], genes$YFB_T_FPKM[x])) >= 4) {
...
for (x in 1:length(genes$gene_id)) {
  if (is.na((max(genes$FB_T_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$FB_T_FPKM[x], genes$FB_KL_FPKM[x])))) {
    genes$DEVREG_FB[x] <- NA 
  } else if ((max(genes$FB_T_FPKM[x], genes$FB_KL_FPKM[x])/min(genes$FB_T_FPKM[x], genes$FB_KL_FPKM[x])) >= 4) {
    genes$DEVREG_FB[x] <- T
  } else {
    genes$DEVREG_FB[x] <- F
  }
