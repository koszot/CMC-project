...
devreg$CMC_gene_id <- str_replace(devreg$CMC_gene_id, "^", "Phchr2_")
...
init$CMC_gene_id <- str_replace(init$CMC_gene_id, "^", "Phchr2_")
...
as$CMC_gene_id <- str_replace(as$CMC_gene_id, "^", "Phchr2_")
...
devreg_as$CMC_gene_id <- str_replace(devreg_as$CMC_gene_id, "^", "Phchr2_")
...
devreg_as_devreg$CMC_gene_id <- str_replace(devreg_as_devreg$CMC_gene_id, "^", "Phchr2_")
...
NOdevreg_as$CMC_gene_id <- str_replace(NOdevreg_as$CMC_gene_id, "^", "Phchr2_")
...
NOdevreg_as_devreg$CMC_gene_id <- str_replace(NOdevreg_as_devreg$CMC_gene_id, "^", "Phchr2_")
...
init_as$CMC_gene_id <- str_replace(init_as$CMC_gene_id, "^", "Phchr2_")
...
init_as_init$CMC_gene_id <- str_replace(init_as_init$CMC_gene_id, "^", "Phchr2_")
...
NOinit_as$CMC_gene_id <- str_replace(NOinit_as$CMC_gene_id, "^", "Phchr2_")
...
NOinit_as_init$CMC_gene_id <- str_replace(NOinit_as_init$CMC_gene_id, "^", "Phchr2_")
