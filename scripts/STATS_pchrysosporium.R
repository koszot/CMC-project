...
annotation <- read_tsv("pchrysosporium_corrected_annotation.gtf",  col_names = c("chr", "maker","type", "start", "end", "att1", "strand", "att2", "attributes")) %>%
...
colnames(stats) <- c("names", "pchrysosporium")
...
write.table(merged, file = "pchrysosporium_AS_genes.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(merged, file = "pchrysosporium_FB_DEVREG_genes.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(merged, file = "pchrysosporium_FB_INIT_genes.gtf", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
