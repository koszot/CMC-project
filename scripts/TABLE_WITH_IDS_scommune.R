...
devreg$CMC_gene_id <- str_replace(devreg$CMC_gene_id, "^", "Schco3_")
...
init$CMC_gene_id <- str_replace(init$CMC_gene_id, "^", "Schco3_")
...
as$CMC_gene_id <- str_replace(as$CMC_gene_id, "^", "Schco3_")
...
devreg_as$CMC_gene_id <- str_replace(devreg_as$CMC_gene_id, "^", "Schco3_")
...
devreg_as_devreg$CMC_gene_id <- str_replace(devreg_as_devreg$CMC_gene_id, "^", "Schco3_")
...
NOdevreg_as$CMC_gene_id <- str_replace(NOdevreg_as$CMC_gene_id, "^", "Schco3_")
...
NOdevreg_as_devreg$CMC_gene_id <- str_replace(NOdevreg_as_devreg$CMC_gene_id, "^", "Schco3_")
...
init_as$CMC_gene_id <- str_replace(init_as$CMC_gene_id, "^", "Schco3_")
...
init_as_init$CMC_gene_id <- str_replace(init_as_init$CMC_gene_id, "^", "Schco3_")
...
NOinit_as$CMC_gene_id <- str_replace(NOinit_as$CMC_gene_id, "^", "Schco3_")
...
NOinit_as_init$CMC_gene_id <- str_replace(NOinit_as_init$CMC_gene_id, "^", "Schco3_")
